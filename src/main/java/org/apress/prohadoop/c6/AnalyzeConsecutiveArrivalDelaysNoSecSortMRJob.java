...
public class AnalyzeConsecutiveArrivalDelaysNoSecSortMRJob extends Configured implements Tool {
    ...
    public int run(String[] allArgs) throws Exception {
        ...
        job.setJarByClass(AnalyzeConsecutiveArrivalDelaysNoSecSortMRJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToolRunner.run(new AnalyzeConsecutiveArrivalDelaysNoSecSortMRJob(), args);
    }
